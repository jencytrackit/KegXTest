...
Namespace TrackITKTS
	Public Class dalTABMenuPrivilege
        ...
        Public Shared Function CreateNewTABMenuPrivilege(ByVal objTABMenuPrivilege As PropertyTABMenuPrivilege) As Integer
        ...
        Public Shared Function GetTABMenuPrivilegeByID(ByVal valPrivID As Int32) As PropertyTABMenuPrivilege
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTABMenuPrivilege As PropertyTABMenuPrivilege = New PropertyTABMenuPrivilege
                While dr.Read
            ...
            Else
                dr.Close()
                Return New PropertyTABMenuPrivilege
            End If
        End Function
