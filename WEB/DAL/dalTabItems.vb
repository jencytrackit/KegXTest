...
Namespace TrackITKTS
    Public Class dalTabItems
        ...
        Public Shared Function GetTabItemsByCompanyID(ByVal valCompanyID As Int32, ByVal SchemaName As String) As DataSet
            ...
            Return ds
        End Function
        Public Shared Function GetTabItemsByEmployeeID(ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetTABAllItemsByEmployeeID")
            Return ds
        End Function
        'HHT Methods
        Public Shared Function GetTabItemsByEmployeeIDHHT(ByVal valEmployeeID As Int32, ByVal schema As String) As DataSet
            ...
            Return ds
        End Function
        Public Shared Function GetTabItemsBySearchHHT(ByVal schema As String, ByVal companyID As Integer, ByVal valSearchKey As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@CompanyID", companyID))
            db.Parameters.Add(New SqlParameter("@SearchKey", valSearchKey))
            Dim ds As DataSet = db.ExecuteDataSet(schema + ".TIT_GetTABAllItemsBySearchHHT")
            Return ds
        End Function

        Public Shared Function GetItemsByChannel(ByVal valchannalname As String, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@ChannelName", valchannalname))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".GetItemsByChannel")
            Return ds
        End Function
