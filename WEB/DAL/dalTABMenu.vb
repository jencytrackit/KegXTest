...
Namespace TrackITKTS
	Public Class dalTABMenu
        ...
        Public Shared Function CreateNewTABMenu(ByVal objTABMenu As PropertyTABMenu) As Integer
        ...
        Public Shared Function GetTABMenuByID(ByVal valMenuID As Int32) As PropertyTABMenu
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTABMenu As PropertyTABMenu = New PropertyTABMenu
                While dr.Read
