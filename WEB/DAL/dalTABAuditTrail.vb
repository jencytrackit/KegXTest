...
Namespace TrackITKTS
    Public Class dalTABAuditTrail
        ...
        Public Shared Function CreateNewTABAuditTrail(ByVal objTABAuditTrail As PropertyTABAuditTrail, ByVal SchemaName As String) As Integer
        ...
        Public Shared Function GetTABAuditTrailByID(ByVal valAuditID As Int32) As PropertyTABAuditTrail
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTABAuditTrail As PropertyTABAuditTrail = New PropertyTABAuditTrail
                While dr.Read
            ...
            Else
                dr.Close()
                Return New PropertyTABAuditTrail
            End If
        End Function
