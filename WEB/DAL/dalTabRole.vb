...
Namespace TrackITKTS
	Public Class dalTabRole
        ...
        Public Shared Function CreateNewTabRole(ByVal objTabRole As PropertyTabRole, ByVal SchemaName As String) As Integer
        ...
        Public Shared Function GetTabRoleByID(ByVal valRoleID As Int32, ByVal SchemaName As String) As PropertyTabRole
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabRole As PropertyTabRole = New PropertyTabRole
                While dr.Read
