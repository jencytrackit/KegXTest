...
Namespace TrackITKTS
    Public Class dalTabMOrganisationMaster
        ...
        Public Shared Function CreateNewTabMOrganization(ByVal objTabMOrganizationMaster As PropertyTabMOrganisationMaster, ByVal SchemaName As String) As Integer
        ...
        Public Shared Function GetTabMOrganizationMasterByID(ByVal valOrganizationID As Int32, ByVal SchemaName As String) As PropertyTabMOrganisationMaster
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabMOrganizationMaster As PropertyTabMOrganisationMaster = New PropertyTabMOrganisationMaster
                While dr.Read
            ...
            Else
                dr.Close()
                Return New PropertyTabMOrganisationMaster
            End If
        End Function
        ...
        Public Shared Function GetTabMOrganizationMasterByOrgCode(ByVal valOrganizationCode As String, ByVal SchemaName As String) As PropertyTabMOrganisationMaster
            Dim db As DBAccess = New DBAccess
        ...
        Public Shared Function GenerateSchema(ByVal OrgCode As String) As String
            ...
            Dim sqlCmd As New SqlCommand()
            db.AddParamToSQLCmd(sqlCmd, "@ReturnValue", SqlDbType.VarChar, 200, ParameterDirection.ReturnValue, Nothing)
            db.AddParamToSQLCmd(sqlCmd, "@OrgCode", SqlDbType.VarChar, 50, ParameterDirection.Input, OrgCode)
            db.AddParamToSQLCmd(sqlCmd, "@SuccessMessage", SqlDbType.VarChar, 3, ParameterDirection.Output, Nothing)
            sqlCmd.CommandTimeout = 120
            db.SetCommandType(sqlCmd, CommandType.StoredProcedure, "TIT_GenerateSchema")
            db.ExecuteScalarCmd(sqlCmd)
            Dim returnValue As String = sqlCmd.Parameters("@SuccessMessage").Value
            If Not String.IsNullOrEmpty(returnValue) Then
                Return returnValue
            Else
                Return ""
