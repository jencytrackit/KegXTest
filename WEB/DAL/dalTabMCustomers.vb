...
Namespace TrackITKTS
    Public Class dalTabMCustomers
        ...
        Public Shared Function CreateNewTabMCustomers(ByVal objTabMCustomers As PropertyTabMCustomers) As Integer
        ...
        Public Shared Function GetTabMCustomersByID(ByVal valCustomerID As Int32, ByVal SchemaName As String) As PropertyTabMCustomers
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabMCustomers As PropertyTabMCustomers = New PropertyTabMCustomers
                While dr.Read
            ...
            Else
                dr.Close()
                Return New PropertyTabMCustomers
            End If
        End Function
        ...
        Public Shared Function GetRptCustomersDrop(ByVal valCompanyID As Int32, ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@CompanyID", valCompanyID))
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetRepCustomers")
            Return ds
        End Function
        ...
        Public Shared Function GetAllTabMCustomersByCustomerCode(ByVal valCustomerCode As String, ByVal SchemaName As String) As PropertyTabMCustomers
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@CustomerCode", valCustomerCode))
            Dim dr As SqlDataReader = CType(db.ExecuteReader(SchemaName + ".TIT_GetAllTabMCustomersByCustomerCode"), SqlDataReader)
            ...
            If dr.HasRows Then
                ...
                While dr.Read
                    ...
                    If Not dr.IsDBNull(dr.GetOrdinal("EmployeeID")) Then
                        objTabMCustomers.EmployeeID = dr.GetInt32(dr.GetOrdinal("EmployeeID"))
                    End If
                End While
                dr.Close()
                Return objTabMCustomers
        ...
        Public Shared Function GetAllTabMCustomersByCusCodeNDCompID(ByVal valCustomerCode As String, ByVal SchemaName As String, ByVal valCompanyID As Int32) As PropertyTabMCustomers
            ...
            db.Parameters.Add(New SqlParameter("@CustomerCode", valCustomerCode))
            db.Parameters.Add(New SqlParameter("@CompanyID", valCompanyID))
            Dim dr As SqlDataReader = CType(db.ExecuteReader(SchemaName + ".TIT_GetAllTabMCustomersByCusCodeNDCompID"), SqlDataReader)
        ...
        Public Shared Function GetTabMCustomersByEmployeeID(ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetAllTabMCustomersByEmployeeID")
            Return ds
        End Function

        Public Shared Function GetRptCustomersByChannel(ByVal valchannalname As String, ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@ChannelName", valchannalname))
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetRepCustomersByChannel")
            Return ds
        End Function
