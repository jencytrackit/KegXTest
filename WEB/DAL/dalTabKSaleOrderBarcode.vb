...
Namespace TrackITKTS
    Public Class dalTabKSaleOrderBarcode
        ...
        Public Shared Function CreateNewTabKSaleOrderBarcode(ByVal objTabKSaleOrderBarcode As PropertyTabKSaleOrderBarcode) As Integer
        ...
        End Function
        'HHT Methods
        Public Shared Function GetAllTabKSaleOrderBarcodeByEmployeeIDHHT(ByVal valEmployeeID As Int32, ByVal schema As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(schema + ".TIT_NewGetAllTabKSaleOrderBarcodeByEmployeeIDHHT")
            Return ds
        End Function
        ...
        Public Shared Function GetSaleOrderItemDetailsByBarcodeHHT(ByVal barcode As String, ByVal schema As String) As DataSet
            ...
            Dim ds As DataSet = db.ExecuteDataSet(schema + ".TIT_GetSaleOrderItemDetailsByBarcodeHHT")
            Return ds
        End Function
    End Class
End Namespace
