...
Namespace TrackITKTS
	Public Class dalTabMSuppliers
        ...
        Public Shared Function CreateNewTabMSuppliers(ByVal objTabMSuppliers As PropertyTabMSuppliers) As Integer
        ...
        Public Shared Function GetTabMSuppliersByID(ByVal valSupplierID As Int32, ByVal SchemaName As String) As PropertyTabMSuppliers
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabMSuppliers As PropertyTabMSuppliers = New PropertyTabMSuppliers
                While dr.Read
            ...
            Else
                dr.Close()
                Return New PropertyTabMSuppliers
            End If
        End Function
        ...
        Public Shared Function GetTabMSuppliersByCompanyID(ByVal valCompanyID As Int32, ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            ...
            Return ds
        End Function
        Public Shared Function GetRptSuppliersDrop(ByVal valCompanyID As Int32, ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@CompanyID", valCompanyID))
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetRepSuppliers")
            Return ds
        End Function
        Public Shared Function GetTabMSuppliersByCode(ByVal valCompanyID As Int32, ByVal valSupplierCode As String, ByVal SchemaName As String) As PropertyTabMSuppliers
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@SupplierCode", valSupplierCode))
            db.Parameters.Add(New SqlParameter("@CompanyID", valCompanyID))
            Dim dr As SqlDataReader = CType(db.ExecuteReader(SchemaName + ".TIT_GetTabMSuppliersByCode"), SqlDataReader)
        ...
        Public Shared Function GetTabMSuppliersByEmployeeID(ByVal valEmployeeID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@EmployeeID", valEmployeeID))
            Dim ds As DataSet = db.ExecuteDataSet(SchemaName + ".TIT_GetAllTabMSuppliersByEmployeeID")
            Return ds
        End Function
