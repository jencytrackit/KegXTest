<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Templates/MasterPage.Master"
    MaintainScrollPositionOnPostback="true" CodeBehind="frmAddEditEmptyKegReturn_CusToBP.aspx.vb"
    Inherits="KEG_X.TrackITKTS.frmAddEditEmptyKegReturn_CusToBP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <script language="javascript" type="text/javascript">
        function redirectme(sender, args) {
            location.href = 'frmEmptyKegReturnList.aspx';
        }
    ...
    <h2>
        <asp:Label ID="addATSEmployees" Text="Empty Kegs Returns Customer to BP" runat="server" /></h2>
                    ...
                    <td valign="Top">
                        <div>
                            <table id="TABLE1" align='left' bordercolor='#ccddef' height="1%" cellspacing='0'
                                ...
                                <tr>
                                    <td class='sideHead'>
                                        <asp:Label ID="Label3" Text="Collection Date" runat="server" />*
                                    </td>
                                    <td class='sideHead1' colspan="3">
                                        <telerik:RadDatePicker ID="dpCollectionDate" runat="server" Width="195px" DateInput-DateFormat="MM/dd/yyyy">
                                        </telerik:RadDatePicker>
                                        <asp:RequiredFieldValidator ID='RequiredFieldValidator7' ControlToValidate='dpCollectionDate'
                                            ErrorMessage="Collection Date is Required" Display='None' runat='server' ValidationGroup="Save" />
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <telerik:RadButton ID="btnAdd" HoveredCssClass="normal-btnh" ForeColor="White" Font-Size="17px"
                                                        Width="100px" Text="Add" runat="server" SingleClick="true" SingleClickText="wait..."  DisabledButtonCssClass="btnDisable"  ValidationGroup="Add" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                ...
                                <tr>
                                    <td align="center" bgcolor="#ffffff" colspan="4">
                                        <telerik:RadButton ID="radSave" HoveredCssClass="normal-btnh" ForeColor="White" Font-Size="17px"
                                            Width="100px"  SingleClick="true" SingleClickText="wait..."  DisabledButtonCssClass="btnDisable"  Text="<%$ Resources:lang, btnSave %>" runat="server" ValidationGroup="Save" />
                                        &nbsp;&nbsp;
