<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Templates/MasterPage.Master"
    CodeBehind="rptSupplierSummary.aspx.vb" Inherits="KEG_X.TrackITKTS.rptSupplierSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <h2>
        <asp:Label ID="addATSUsers" Text="Supplier Summary Report" runat="server" /></h2>
