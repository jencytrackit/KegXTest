...
Namespace TrackITKTS
	Public Class dalTabUOMMaster
		...
		Public Shared Function CreateNewTabUOMMaster(ByVal objTabUOMMaster As clsTabUOMMaster) As Integer
		...
		Public Shared Function GetTabUOMMasterByID(ByVal valUOMID As Int32) As clsTabUOMMaster
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTabUOMMaster As clsTabUOMMaster = New clsTabUOMMaster
				While dr.Read
		...
		Public Shared Function GetTabUOMMasterByItemID(ByVal valItemID As Int32) As DataSet
			...
			Return ds
		End Function
        Public Shared Function GetTabUOMMasterByItemCode(ByVal valItemCode As String, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
