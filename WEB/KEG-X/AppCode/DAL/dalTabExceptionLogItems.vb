...
Namespace TrackITKTS
	Public Class dalTabExceptionLogItems
		...
		Public Shared Function CreateNewTabExceptionLogItems(ByVal objTabExceptionLogItems As clsTabExceptionLogItems) As Integer
		...
		Public Shared Function GetTabExceptionLogItemsByID(ByVal valEventId As Int32) As clsTabExceptionLogItems
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTabExceptionLogItems As clsTabExceptionLogItems = New clsTabExceptionLogItems
				While dr.Read
			...
			Else
				dr.Close()
				Return New clsTabExceptionLogItems
			End If
		End Function
