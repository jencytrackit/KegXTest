...
Namespace TrackITKTS
	Public Class dalTabMCompEmp
        ...
        Public Shared Function CreateNewTabMCompEmp(ByVal objTabMCompEmp As clsTabMCompEmp, ByVal SchemaName As String) As Integer
		...
		Public Shared Function GetTabMCompEmpByID(ByVal valCompanyID As Int32) As clsTabMCompEmp
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTabMCompEmp As clsTabMCompEmp = New clsTabMCompEmp
				While dr.Read
