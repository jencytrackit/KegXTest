...
Namespace TrackITKTS
	Public Class dalTabKSupplierReceive
		...
		Public Shared Function CreateNewTabKSupplierReceive(ByVal objTabKSupplierReceive As clsTabKSupplierReceive) As Integer
		...
		Public Shared Function GetTabKSupplierReceiveByID(ByVal valOrderID As Int32) As clsTabKSupplierReceive
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTabKSupplierReceive As clsTabKSupplierReceive = New clsTabKSupplierReceive
				While dr.Read
			...
			Else
				dr.Close()
				Return New clsTabKSupplierReceive
			End If
		End Function
		...
		Public Shared Function GetTabKSupplierReceiveBySupplierID(ByVal valSupplierID As Int32) As DataSet
			...
			Return ds
		End Function
        Public Shared Function GetTabKSupplierReceiveByCompanyID(ByVal valCompanyID As Int32, ByVal SchemaName As String) As DataSet
            Dim db As DBAccess = New DBAccess
