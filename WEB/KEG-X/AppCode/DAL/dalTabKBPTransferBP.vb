...
Namespace TrackITKTS
	Public Class dalTabKBPTransferBP
		...
		Public Shared Function CreateNewTabKBPTransferBP(ByVal objTabKBPTransferBP As clsTabKBPTransferBP) As Integer
		...
		Public Shared Function GetTabKBPTransferBPByID(ByVal valTOrderID As Int32) As clsTabKBPTransferBP
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTabKBPTransferBP As clsTabKBPTransferBP = New clsTabKBPTransferBP
				While dr.Read
			...
			Else
				dr.Close()
				Return New clsTabKBPTransferBP
			End If
		End Function
		...
		Public Shared Function GetTabKBPTransferBPByFromBranchID(ByVal valFromBranchID As Int32) As DataSet
			...
			Return ds
		End Function
        Public Shared Function GetAllTabKBPTransferBPByCompanyID(ByVal valCompanyID As Int32) As DataSet
            Dim db As DBAccess = New DBAccess
            db.Parameters.Add(New SqlParameter("@CompanyID", valCompanyID))
            Dim ds As DataSet = db.ExecuteDataSet("TIT_GetAllTabKBPTransferBPByCompanyID")
            Return ds
        End Function
	End Class
End Namespace
