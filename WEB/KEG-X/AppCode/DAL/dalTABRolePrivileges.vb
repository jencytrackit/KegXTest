...
Namespace TrackITKTS
	Public Class dalTABRolePrivileges
        ...
        Public Shared Function CreateNewTABRolePrivileges(ByVal objTABRolePrivileges As clsTABRolePrivileges, ByVal SchemaName As String) As Integer
		...
		Public Shared Function GetTABRolePrivilegesByID(ByVal valPrivilegeID As Int32) As clsTABRolePrivileges
			Dim db As DBAccess = New DBAccess
			...
			If dr.HasRows Then
				Dim objTABRolePrivileges As clsTABRolePrivileges = New clsTABRolePrivileges
				While dr.Read
			...
			Else
				dr.Close()
				Return New clsTABRolePrivileges
			End If
		End Function
