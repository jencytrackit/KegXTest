...
Namespace TrackITKTS
	Public Class dalTabMEmployees
        ...
        Public Shared Function CreateNewTabMEmployees(ByVal objTabMEmployees As clsTabMEmployees, ByVal SchemaName As String) As Integer
        ...
        Public Shared Function GetTabMEmployeesByID(ByVal valEmployeeID As Int32, ByVal SchemaName As String) As clsTabMEmployees
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabMEmployees As clsTabMEmployees = New clsTabMEmployees
                While dr.Read
        ...
        Public Shared Function UpdateATSUserPassword(ByVal objATSUsers As clsTabMEmployees, ByVal oldPass As String) As Boolean
            ...
            db.AddParamToSQLCmd(sqlCmd, "@Password", SqlDbType.NVarChar, 50, ParameterDirection.Input, objATSUsers.Password)
            db.AddParamToSQLCmd(sqlCmd, "@OldPassword", SqlDbType.NVarChar, 50, ParameterDirection.Input, oldPass)
