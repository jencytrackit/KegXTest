...
Namespace TrackITKTS
	Public Class dalTabMOrganization
		...
		Public Shared Function CreateNewTabMOrganization(ByVal objTabMOrganization As clsTabMOrganization) As Integer
        ...
        Public Shared Function GetTabMOrganizationByID(ByVal valCompanyID As Int32, ByVal SchemaName As String) As clsTabMOrganization
            Dim db As DBAccess = New DBAccess
            ...
            If dr.HasRows Then
                Dim objTabMOrganization As clsTabMOrganization = New clsTabMOrganization
                While dr.Read
            ...
            Else
                dr.Close()
                Return New clsTabMOrganization
            End If
        End Function
