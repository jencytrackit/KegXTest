...
'File Name : rptEmptiesinyard.aspx
'Created By : 
'File navigation :
'Created Date : November 15, 2013, 11:00:44 AM
'Description : This is used to show Empties in yard details Report
'Modified By :
'Modified Date :
'***************************************************************
...
Namespace TrackITKTS
    Partial Class rptEmptiesinyard
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then 'filling company dropdown values and setting customerName,CustomerCode dropdowns intial value 
                ...
                BindCompany()
                Session("rReportsEmpties") = Nothing
            Else
                'BindReport()
            End If
        End Sub
        ...
        Private Sub BindReport()
            ...
            If Session("rReportsEmpties") Is Nothing Then Return

            Dim intCompanyID As Integer = Session("rReportsEmpties")("rCompanyID")
            Dim strItemID As String = Session("rReportsEmpties")("rItem")
            repPath = System.Configuration.ConfigurationManager.AppSettings("ReportPath") & "Emptiesinyard.rpt" 'Intializing repPath variable to the actual report path
            ...
            'ds = clsReports.REPTotalKegEmpties(rcbCompany.SelectedItem.Value, objuserInfo("schemaName"))
            ds = clsReports.REPTotalKegEmpties(intCompanyID, strItemID, objuserInfo("schemaName"))
            ...
            rep.SummaryInfo.ReportTitle = Session("rReportsEmpties")("rCompanyName")
