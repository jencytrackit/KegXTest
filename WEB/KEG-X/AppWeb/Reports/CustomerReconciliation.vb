...
Public Class CustomerReconciliation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CustomerReconciliation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KEG_X.CustomerReconciliation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MultipleCustomerIDs() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCustomerReconciliation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomerReconciliation = New CustomerReconciliation()
        rpt.Site = Me.Site
        Return rpt
    End Function
