...
Public Class TotalKegPopulation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KEG_X.TotalKegPopulation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalKegPopulation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalKegPopulation = New TotalKegPopulation()
        rpt.Site = Me.Site
        Return rpt
    End Function
