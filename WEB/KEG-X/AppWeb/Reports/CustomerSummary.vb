...
Public Class CustomerSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KEG_X.CustomerSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ChannelName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCustomerSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomerSummary = New CustomerSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
