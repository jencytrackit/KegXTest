...
Public Class Emptiesinyard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KEG_X.Emptiesinyard.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MultipleItemIDs() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEmptiesinyard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Emptiesinyard = New Emptiesinyard()
        rpt.Site = Me.Site
        Return rpt
    End Function
