<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Templates/MasterPage.Master" MaintainScrollPositionOnPostback ="true"
    CodeBehind="frmAddEditEmptyKegReturn_BPToSupplier.aspx.vb" Inherits="KEG_X.TrackITKTS.frmAddEditEmptyKegReturn_BPToSupplier" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <script language="javascript" type="text/javascript">
        function redirectme(sender, args) {
            location.href = 'frmEmptyKegReturn_ToSupplier.aspx';
        }
...
//            button.set_autoPostBack(false);
    ...
    <h2><asp:Label ID="addATSEmployees" Text="Empty Kegs Returns - BP To Supplier" runat="server" /></h2>
            ...
            <td height="450px" valign="Top">
                ...
                <div>
                    <table id="TABLE1" align='left' bordercolor='#ccddef' height="1%" cellspacing='0'
                        ...
                        <tr>
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label2" Text="BranchPlant" runat="server" />*
                            </td>
                            <td class='sideHead1' width="30%">
                      ...
                      <div id="divFromBP" runat="server" class="autocomplete_completionListElement">
                                ...
                                <asp:RequiredFieldValidator ID='RequiredFieldValidator2' ControlToValidate='txtFromBP'
                                    ErrorMessage="From BranchPlant is Required" Display='None' runat='server' ValidationGroup="Add" />
                            </td>
                            </tr>
                             <tr>
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label12" Text="To Company" runat="server" />*
                            </td>
                            <td class='sideHead1' width="30%">
                        ...
                        <tr>
                            ...
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label7" Text="BOL Date" runat="server" />
                            </td>
                            <td class='sideHead1' width="30%">
                                <telerik:RadDatePicker ID="dtBOLDate" runat="server" Width="195px" DateInput-DateFormat="MM/dd/yyyy" ShowPopupOnFocus ="true">
                        ...
                        <tr>
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label8" Text="Port From" runat="server" />
                            </td>
                            <td class='sideHead1' width="30%">
                                <telerik:RadTextBox ID="txtPortFrom" runat="server" Width="195px">
                                </telerik:RadTextBox>
                                
                            </td>
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label9" Text="Port To" runat="server" />
                            </td>
                            <td class='sideHead1' width="30%">
                                <telerik:RadTextBox ID="txtPortTo" runat="server" Width="195px">
                                </telerik:RadTextBox>
                        ...
                        <tr>
                            <td class='sideHead' width="20%">
                                <asp:Label ID="Label4" Text="Shipping Line" runat="server" />
                            </td>
                            <td class='sideHead1' width="30%">
                            ...
                            <%--<td class='sideHead' width="20%">
                                <asp:Label ID="Label5" Text="SerialNo" runat="server" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td class='sideHead1' colspan="3">
                                <telerik:RadDatePicker ID="dpReturnDate" runat="server" Width="195px" DateInput-DateFormat="MM/dd/yyyy" ShowPopupOnFocus ="true">
                                </telerik:RadDatePicker>
                       ...
                       <%--     <td class='sideHead1' width="30%">
                        ...
                        <tr>
                            ...
                            <td class='sideHead1' width="30%">
                                ...
                                <asp:RequiredFieldValidator ID='RequiredFieldValidator5' ControlToValidate='txtQuantity' onkeyPress="return OnlyNumbers(event);"
                                ...
                                <telerik:RadGrid ID="RadgvEmptyKegTransfer" runat="server" CellSpacing="0" GridLines="None"
                                    ...
                                    <MasterTableView AutoGenerateColumns="false" NoMasterRecordsText="<%$ Resources:lang, msgNoRecords %>"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn AllowFiltering="false" HeaderText="ESOrderID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblESOrderID" runat="server" Text='<%# Eval("ESOrderID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
                                    </MasterTableView>
                        ...
                        <tr>
                            <td align="center" bgcolor="#ffffff" colspan="4">
                                <telerik:RadButton ID="radSave" HoveredCssClass="normal-btnh" ForeColor="White" Font-Size="17px" Width="100px" Text="<%$ Resources:lang, btnSave %>"
                                    runat="server" ValidationGroup="Save" SingleClick="true" SingleClickText="wait..."  DisabledButtonCssClass="btnDisable" />
                                &nbsp;&nbsp;
                                <telerik:RadButton ID="radClear" HoveredCssClass="normal-btnh" ForeColor="White" Font-Size="17px" Width="100px" Text="<%$ Resources:lang, btnClear %>"
                                    runat="server" AutoPostBack="false" OnClientClicked="OnClientClicked" CausesValidation="False" />
                                &nbsp;&nbsp;
