<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="rptTotalKegPopulation.aspx.vb"
    MasterPageFile="~/Templates/MasterPage.Master" Inherits="KEG_X.TrackITKTS.rptTotalKegPopulation" %>
...
.clsHide
{
    ...
    <h2>
        <asp:Label ID="addATSUsers" Text="Total Keg population Report" runat="server" /></h2>
                ...
                <div>
                    ...
                    <table id="TABLE4" align='left' bordercolor='#ccddef' height="1%" cellspacing='0'
                        ...
                        <tr valign='top' height="5%">
                            <td class='callOutStyle' colspan="7">
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor='white' valign="top" colspan="7">
