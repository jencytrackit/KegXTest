...
Namespace TrackITKTS
    ...
    Partial Public Class rptCustomerEmptyKegCollection
        ...
        '''<summary>
        '''rfvrcbUsername control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents rfvrcbUsername As Global.System.Web.UI.WebControls.RequiredFieldValidator
