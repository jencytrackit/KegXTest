...
'File Name : rptCustomerSummary.aspx
'Created By : 
'File navigation :
'Created Date : November 15, 2013, 11:00:44 AM
'Description : This is used to show Customer Summary Details Report
'Modified By :
'Modified Date :
'***************************************************************
...
Namespace TrackITKTS
    Partial Class rptCustomerSummary
        ...
        Private Sub BindReport()
            ...
            If Session("rReportsCSumm") Is Nothing Then Return

            Dim ChannelName As String = Session("rReportsCSumm")("rChannelName")
            Dim dtFromDate As DateTime = Session("rReportsCSumm")("rFromDate") 'DateTime.ParseExact(Session("rReportsCSumm")("rFromDate"), "yyyy-MM-dd HH:mm tt", CultureInfo.InvariantCulture)
            Dim dttoDate As DateTime = Session("rReportsCSumm")("rToDate") 'DateTime.ParseExact(Session("rReportsCSumm")("rToDate"), "yyyy-MM-dd HH:mm tt", CultureInfo.InvariantCulture)
            Dim strItemID As String = Session("rReportsCSumm")("rItem")
            ...
            repPath = System.Configuration.ConfigurationManager.AppSettings("ReportPath") & "CustomerSummary.rpt" 'Intializing repPath variable to the actual report path
            ...
            'ds = clsReports.REPCustomerSummary(rcbCompany.SelectedItem.Value, FromDt.SelectedDate, ToDt.SelectedDate, objuserInfo("schemaName"))
            ds = clsReports.REPCustomerSummary(ChannelName, dtFromDate, dttoDate, strItemID, objuserInfo("schemaName"))
            ...
            Next
            rep.SummaryInfo.ReportTitle = Session("rReportsCSumm")("rChannelName")
