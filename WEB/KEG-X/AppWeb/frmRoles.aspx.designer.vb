...
Namespace TrackITKTS
    ...
    Partial Public Class frmRoles
        ...
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents RadgvRoles As Global.Telerik.Web.UI.RadGrid

        '''<summary>
        '''ObjDSTABUserPrivileges control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents ObjDSTABUserPrivileges As Global.System.Web.UI.WebControls.ObjectDataSource
    End Class
End Namespace
