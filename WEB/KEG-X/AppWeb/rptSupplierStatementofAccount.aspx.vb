...
'File Name : rptSupplierStatementofAccount.aspx
'Created By : 
'File navigation :
'Created Date : November 15, 2013, 11:00:44 AM
'Description : This is used to show Supplier Statement of Account details Report
'Modified By :
'Modified Date :
'***************************************************************
    ...
    Partial Class rptSupplierStatementofAccount
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not Page.IsPostBack Then 'filling company dropdown values and setting customerName,CustomerCode dropdowns intial value 
                ...
                BindCompany()
                Session("rReportsSupSOA") = Nothing
        ...
        Private Sub BindReport()
            ...
            If Session("rReportsSupSOA") Is Nothing Then Return

            Dim intCompanyID As Integer = Session("rReportsSupSOA")("rCompanyID")
            Dim intSupplierID As String = Session("rReportsSupSOA")("rSupplier")
            Dim strItemID As String = Session("rReportsSupSOA")("rItem")
            Dim dtFromDate As DateTime = Session("rReportsSupSOA")("rFromDate")
            Dim dttoDate As DateTime = Session("rReportsSupSOA")("rToDate")
            ...
            repPath = System.Configuration.ConfigurationManager.AppSettings("ReportPath") & "SupplierSOA.rpt" 'Intializing repPath variable to the actual report path
            ...
            'ds = clsReports.REPSupplierSOA(rcbCompany.SelectedItem.Value, FromDt.SelectedDate, ToDt.SelectedDate, hdfSupplierID.Value, objuserInfo("schemaName"))
            ds = clsReports.REPSupplierSOA(intCompanyID, dtFromDate, dttoDate, intSupplierID, strItemID, objuserInfo("schemaName"))
            ...
            'rep.DataDefinition.RecordSelectionFormula = Filter 'Filtering the report 
            rep.SummaryInfo.ReportTitle = Session("rReportsSupSOA")("rCompanyName")
